...
userRouter.post("/", validateUser,authenticationToken, usersController.createUser);
userRouter.put("/:user_id",validateUser,authenticationToken, usersController.updateUser);
